...
<div class="login-card">
  ...
  @if(session('success'))
    <div class="alert" style="background: rgba(82,121,111,.10); border-color: #52796f; color: #52796f;">
  ...
  <form action="{{ route('auth.reset-password.post') }}" method="POST">
    ...
    <div class="form-group">
      ...
      <div class="input-wrap">
        ...
        <input type="password" name="password" id="password" class="form-control" placeholder="Enter new password" required autocomplete="new-password" minlength="8" onchange="checkPasswordStrength()">
        <button type="button" class="pwd-toggle" onclick="togglePasswordVisibility('password')">
    ...
    <div class="form-group">
      ...
      <div class="input-wrap">
        ...
        <input type="password" name="password_confirmation" id="password_confirmation" class="form-control" placeholder="Confirm password" required autocomplete="new-password" minlength="8">
        <button type="button" class="pwd-toggle" onclick="togglePasswordVisibility('password_confirmation')">
          <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>
        </button>
      </div>
    </div>
    ...
    <button type="submit" class="btn-login">
      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm3.5 6.5l-5.5 5.5-2.5-2.5"/></svg>
      Reset Password
    </button>
  </form>
...
function checkPasswordStrength() {
  ...
  if (/[0-9]/.test(pwd) && /[!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?]/.test(pwd)) strength++;

  for (let i = 0; i < strength; i++) {
    bars[i].classList.add(strength === 1 ? 'weak' : strength === 2 ? 'medium' : 'strong');
  }
}
