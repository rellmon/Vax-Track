<?php $__env->startSection('page-title', 'Child Profile'); ?>
  ...
  <div class="section-grid mb-4">
    <div class="card">
      <div class="card-header">
        ...
        <a href="<?php echo e(route('doctor.children.edit', $child)); ?>" class="btn btn-sm btn-secondary" style="display:inline-flex;align-items:center;gap:5px;">
      ...
      <div class="card-body">
        <div class="info-grid">
          <div class="info-item"><label>Full Name</label><p><?php echo e($child->full_name); ?></p></div>
          <div class="info-item"><label>Date of Birth</label><p><?php echo e(\Carbon\Carbon::parse($child->dob)->format('F j, Y')); ?></p></div>
          <div class="info-item"><label>Age</label><p><?php echo e($child->age); ?></p></div>
          <div class="info-item"><label>Gender</label><p><?php echo e($child->gender); ?></p></div>
          <div class="info-item"><label>Blood Type</label><p><?php echo e($child->blood_type ?: '—'); ?></p></div>
          <div class="info-item"><label>Address</label><p><?php echo e($child->address ?: '—'); ?></p></div>
        </div>
        <?php if($child->notes): ?>
    ...
    <div class="card">
      ...
      <div class="card-body">
        <?php if($child->parent): ?>
          <div class="info-grid">
            <div class="info-item"><label>Name</label><p><?php echo e($child->parent->full_name); ?></p></div>
            <div class="info-item"><label>Phone</label><p><?php echo e($child->parent->phone ?: '—'); ?></p></div>
            <div class="info-item"><label>Email</label><p><?php echo e($child->parent->email ?: '—'); ?></p></div>
            <div class="info-item"><label>Username</label><p><?php echo e($child->parent->username ?: '—'); ?></p></div>
          </div>
        <?php else: ?>
    ...
    <div class="card">
      ...
      <div class="table-wrapper">
        <table>
          ...
          <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $child->vaccineRecords; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
              <tr>
                <td><strong><?php echo e($r->vaccine?->name); ?></strong> <span class="badge badge-blue"><?php echo e($r->vaccine?->type); ?></span></td>
                <td><?php echo e(\Carbon\Carbon::parse($r->date_given)->format('M j, Y')); ?></td>
                <td>Dose <?php echo e($r->dose_number); ?></td>
                <td><?php echo e($r->administered_by); ?></td>
              </tr>
    ...
    <div class="card">
      ...
      <div class="table-wrapper">
        <table>
          ...
          <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $child->schedules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
              <tr>
...
<div class="modal-overlay" id="addPastVaccineModal" onclick="if(event.target===this)closeAddVaccineModal()">
  <div class="modal modal-md">
    ...
    <form id="pastVaccineForm" action="<?php echo e(route('doctor.children.addVaccine', $child)); ?>" method="POST">
      <?php echo csrf_field(); ?>
          ...
          <div class="form-group">
            ...
            <select name="vaccine_id" class="form-control" required>
              ...
              <?php $__currentLoopData = $vaccines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($v->id); ?>"><?php echo e($v->name); ?> (<?php echo e($v->type); ?>)</option>
...
<?php echo $__env->make('layouts.doctor', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\vacctrack\resources\views/doctor/children-show.blade.php ENDPATH**/ ?>