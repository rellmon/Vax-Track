  ...
  <div class="vaccine-booklet">
    ...
    <div class="booklet-header">
      ...
      <div class="booklet-info-section">
        <div class="info-field">
          ...
          <value><?php echo e($child->full_name); ?></value>
        </div>
        <div class="info-field">
          <label>Date of Birth</label>
          <value><?php echo e(\Carbon\Carbon::parse($child->dob)->format('F j, Y')); ?></value>
        </div>
        <div class="info-field">
          <label>Age</label>
          <value><?php echo e($child->age); ?></value>
        </div>
        <div class="info-field">
          <label>Gender</label>
          <value><?php echo e(ucfirst($child->gender)); ?></value>
        </div>
        <div class="info-field">
          <label>Blood Type</label>
          <value><?php echo e($child->blood_type ?: 'Not recorded'); ?></value>
        </div>
        <div class="info-field">
          <label>Address</label>
          <value><?php echo e($child->address ?: 'Not recorded'); ?></value>
        </div>
      </div>
    </div>
    ...
    <?php if($nextSched): ?>
      <div class="next-appointment-banner">
        ...
        <div>
          <strong>Next Appointment:</strong> <?php echo e($nextSched->vaccine?->name); ?> on <?php echo e(\Carbon\Carbon::parse($nextSched->appointment_date)->format('M j, Y')); ?> at <?php echo e(\Carbon\Carbon::parse($nextSched->appointment_time)->format('g:i A')); ?>
    ...
    <div class="booklet-content">
      <div class="vaccine-table-wrapper">
        <table class="vaccine-table">
          ...
          <tbody>
            <?php $__empty_2 = true; $__currentLoopData = $vaccines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vaccine): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
              <?php
                $vaccineRecord = $records->where('vaccine_id', $vaccine->id)->first();
              ?>
              <tr class="<?php echo e($vaccineRecord ? 'vaccine-row-done' : ''); ?>">
                <td class="vaccine-name"><?php echo e($vaccine->name); ?></td>
                <td style="text-align: center;">
                  <?php if($vaccineRecord): ?>
                    <span class="dose-badge"><?php echo e($vaccineRecord->dose_number); ?></span>
                  <?php else: ?>
                ...
                <td class="vaccine-date">
                  <?php if($vaccineRecord): ?>
                    <?php echo e(\Carbon\Carbon::parse($vaccineRecord->date_given)->format('m/d/Y')); ?>
    ...
    <div class="booklet-footer">
      <span>Total Vaccinations: <strong><?php echo e($records->count()); ?></strong> / <?php echo e($vaccines->count()); ?></span>
      <span>Last Updated: <?php echo e(now()->format('M j, Y')); ?></span>
    </div>
    ...
    <?php if($child->notes): ?>
      <div style="padding: 16px 28px; background: #FAFAF9; border-top: 1px solid #E8E8E8;">
        ...
        <div style="font-size: 13px; color: #2f3e46;"><?php echo e($child->notes); ?></div>
      </div>
    <?php endif; ?>
  </div>
