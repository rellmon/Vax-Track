<?php $__env->startSection('page-title', 'Register Child — Existing Parent'); ?>
...
<div style="max-width:680px;">
  ...
  <form action="<?php echo e(route('doctor.children.store-existing')); ?>" method="POST">
    <?php echo csrf_field(); ?>
    <div class="card mb-4">
      ...
      <div class="card-body">
        <div class="form-group">
          ...
          <select name="parent_id" class="form-control" required>
            ...
            <?php $__currentLoopData = $parents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><option value="<?php echo e($p->id); ?>"><?php echo e($p->full_name); ?> (<?php echo e($p->phone); ?>)</option><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          </select>
        </div>
      </div>
    </div>
    ...
    <div class="card mb-4">
      ...
      <div class="card-body">
        ...
        <div class="form-group"><label>Notes / Allergies</label><textarea name="notes" class="form-control" rows="2" maxlength="500"></textarea></div>
      </div>
    </div>
...
<script>
document.querySelectorAll('input[name="first_name"], input[name="last_name"]').forEach(field => {
...
<?php echo $__env->make('layouts.doctor', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\vacctrack\resources\views/doctor/children-create-existing.blade.php ENDPATH**/ ?>