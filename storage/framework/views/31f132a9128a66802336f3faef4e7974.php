  ...
  <form action="<?php echo e(route('login.post')); ?>" method="POST">
    ...
    <div class="form-group">
      ...
      <div class="input-wrap">
        ...
        <input type="text" name="username" class="form-control" placeholder="Enter your username" value="<?php echo e(old('username')); ?>" required autocomplete="username">
      </div>
    </div>
...
</html><?php /**PATH D:\vacctrack\resources\views/auth/login.blade.php ENDPATH**/ ?>