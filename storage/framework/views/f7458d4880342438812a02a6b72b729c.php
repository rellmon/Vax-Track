<?php $__env->startSection('page-title', 'Vaccination Records'); ?>
    ...
    <table>
      ...
      <tbody>
        <?php $__empty_1 = true; $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
          <tr>
            <td><strong><?php echo e($r->child?->full_name); ?></strong></td>
            <td><?php echo e($r->vaccine?->name); ?></td>
            <td><span class="badge badge-blue"><?php echo e($r->vaccine?->type); ?></span></td>
            <td><?php echo e(\Carbon\Carbon::parse($r->date_given)->format('F j, Y')); ?></td>
      ...
      <div id="childSelectContainer" style="display:none;margin-bottom:20px;">
        ...
        <select id="childSelect" class="form-control">
          <?php $__currentLoopData = $children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value="<?php echo e($child->id); ?>"><?php echo e($child->full_name); ?></option>
...
function handlePrint() {
  ...
  let url = '<?php echo e(route("parent.print-records")); ?>?type=' + printOption;
...
<?php echo $__env->make('layouts.parent', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\vacctrack\resources\views/parent/records.blade.php ENDPATH**/ ?>