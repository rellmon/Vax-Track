...
<div class="payment-stats-improved">
  <div class="pay-stat-card" style="border-left: 4px solid var(--forest);">
    ...
    <p class="pay-stat-val-new" style="color: var(--forest);">₱<?php echo e(number_format($totalRevenue, 2)); ?></p>
  ...
  <div class="pay-stat-card" style="border-left: 4px solid var(--amber);">
    ...
    <p class="pay-stat-val-new" style="color: var(--amber);">₱<?php echo e(number_format($pendingTotal, 2)); ?></p>
  ...
  <div class="pay-stat-card" style="border-left: 4px solid #22c55e;">
    ...
    <p class="pay-stat-val-new" style="color: #22c55e;">₱<?php echo e(number_format($todayRevenue, 2)); ?></p>
    <div class="pay-stat-trend"><?php echo e(now()->format('F j, Y')); ?></div>
  </div>
</div>
...
<div class="toolbar-improved">
  ...
  <div style="display: flex; gap: 12px;">
    <a href="<?php echo e(route('doctor.payments.report')); ?>" target="_blank" class="btn btn-secondary" style="display:inline-flex;align-items:center;gap:8px;">
      ...
      <tbody>
        <?php $__empty_1 = true; $__currentLoopData = $payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
          <tr>
            ...
            <td><?php echo e(\Carbon\Carbon::parse($p->payment_date)->format('M j, Y')); ?></td>
            ...
            <td>
              <div class="flex gap-2">
                <a href="<?php echo e(route('doctor.payments.show', $p)); ?>" class="btn btn-sm btn-secondary" style="display:inline-flex;align-items:center;gap:5px;">
                  <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8Z"/><circle cx="12" cy="12" r="3"/></svg>
                  View
                </a>
                <a href="<?php echo e(route('doctor.payments.invoice', $p)); ?>" target="_blank" class="btn btn-sm btn-secondary" style="display:inline-flex;align-items:center;gap:5px;">
                ...
                <?php if($p->status === 'Pending'): ?>
                  <form action="<?php echo e(route('doctor.payments.status', $p)); ?>" method="POST" style="display:inline;">
...
<div class="modal-overlay" id="modal-payment" onclick="if(event.target===this)this.classList.remove('open')">
  <div class="modal modal-md">
    ...
    <form action="<?php echo e(route('doctor.payments.store')); ?>" method="POST">
      <?php echo csrf_field(); ?>
      <div class="modal-body">
        <div class="form-group">
          ...
          <select name="schedule_id" class="form-control" required id="pay-sched-sel" onchange="updateAmount(this)">
            ...
            <?php $__currentLoopData = $unpaidSchedules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <option value="<?php echo e($s->id); ?>" data-price="<?php echo e($s->vaccine?->price); ?>">
                <?php echo e($s->child?->full_name); ?> — <?php echo e($s->vaccine?->name); ?> (<?php echo e(\Carbon\Carbon::parse($s->appointment_date)->format('M j')); ?>) — ₱<?php echo e(number_format($s->vaccine?->price ?? 0, 2)); ?>
        ...
        <div class="form-group">
          ...
          <input type="date" name="payment_date" class="form-control" value="<?php echo e(today()->format('Y-m-d')); ?>" required>
        </div>
        <div class="form-group">
          <label>Status</label>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.doctor', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\vacctrack\resources\views/doctor/payments.blade.php ENDPATH**/ ?>