...
<p>Generated: <?php echo e(now()->format('F j, Y g:i A')); ?></p>
<table>
  ...
  <tbody>
    <?php $__currentLoopData = $payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <tr>
        ...
        <td><?php echo e($p->child?->full_name); ?></td>
...
<div class="total">Total Revenue: ₱<?php echo e(number_format($totalRevenue, 2)); ?></div>
<script>window.print();</script>
</body>
</html><?php /**PATH D:\vacctrack\resources\views/doctor/payments-report.blade.php ENDPATH**/ ?>