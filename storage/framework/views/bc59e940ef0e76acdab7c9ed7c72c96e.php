...
<div class="login-card">
  ...
  <form action="<?php echo e(route('auth.send-otp')); ?>" method="POST">
    <?php echo csrf_field(); ?>
    ...
    <div class="form-group">
      ...
      <div class="input-wrap">
        ...
        <input type="email" name="email" class="form-control" placeholder="your@email.com" value="<?php echo e(old('email')); ?>" required autocomplete="email">
      </div>
...
<?php /**PATH D:\vacctrack\resources\views/auth/forgot-password.blade.php ENDPATH**/ ?>